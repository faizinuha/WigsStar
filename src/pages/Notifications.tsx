...
export const Notifications = () => {
      ...
      return [
        {
          ...
          from_user: {
            ...
            avatar_url: "https://images.unsplash.com/photo-1494790108755-2616b612b977?w=150&h=150&fit=crop&crop=face"
          }
        },
        {
          id: "2",
  ...
  const getNotificationMessage = (type: string, fromUser: any) => {
    const displayName = fromUser?.display_name || fromUser?.username || 'Someone';
